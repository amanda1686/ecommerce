...
function SectionServices({
  ...
  return (
    <section className="flex flex-col md:flex-row items-center justify-between bg-white rounded-md p-14 md:m-12 shadow-md mx-auto">
      <div className="w-full md:w-2/4 md:text-left mb-4 md:mb-0">
        <img
